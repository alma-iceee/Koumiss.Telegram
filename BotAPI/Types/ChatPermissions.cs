...
#nullable enable
        /// <summary>
        /// Optional. True, if the user is allowed to send text messages, contacts, locations
        /// and venues.
        /// </summary>
        ...
        /// <summary>
        /// Optional. True, if the user is allowed to send polls, implies <see
        /// cref="CanSendMessages"/>
        /// </summary>
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
